...
import { pool } from './src/utils/dbController.js';
import baseRoute from './src/routes/v1/base.js';
dotenv.config();
...
app.use('/swagger-dark.css', express.static(path.join(__dirname, '/utils/swagger-dark.css')));
